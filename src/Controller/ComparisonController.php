 ...
 */
#[\Pimcore\Bundle\ComparisonBundle\Feature\Attribute\AsFeature(id: 'api.rest', group: 'api', name: 'Comparison REST API', description: 'Studio REST endpoints: objects, objects/summary, objects/export; permission-gated, ETag, ProblemDetails.', status: \Pimcore\Bundle\ComparisonBundle\Feature\FeatureStatus::IN_PROGRESS, openGaps: ['Covered by Playwright API E2E (tests/e2e/specs/api); a PHPUnit functional test would promote it to beta'], specRefs: ['FR-CMP-020', 'FR-CMP-026', 'FR-CMP-027', 'FR-CMP-028'], dependsOn: ['core.comparison-service'], since: '2026-07-24', backendOnly: true)]
